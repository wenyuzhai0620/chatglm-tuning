...
checkpoint = "D:\\Anaconda3\\ChatGLM-6B-main\\ChatGLM-6B-main\\chatglm_6b"
...
def create_inputs_and_labels(tokenizer, question, answer, device):
    ...
    labels = [-100] * len(prompt) + completion + [eop] # 无需处理的label -100，无需考虑非标识的数值
...
train_data = []
with open("data/qa0627.json", encoding="utf-8") as file:
